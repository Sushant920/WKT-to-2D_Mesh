#!/usr/bin/env python3
"""
Streamlit CAD to 2D Mesh Application
...
def create_mesh_from_wkt(wkt_polygon, title, mesh_params):
    """
    Create a 2D mesh from WKT polygon
    """
    try:
        # Parse WKT geometry
        ...
        # Initialize Gmsh with options to avoid signal issues
        gmsh.initialize()
        gmsh.option.setNumber("General.Terminal", 0)  # Disable terminal output
        gmsh.option.setNumber("General.Verbosity", 0)  # Reduce verbosity
