#!/usr/bin/env python3
"""
Streamlit 3D CAD to Mesh Application
...
def create_3d_mesh():
    try:
        ...
        elif geometry_type == "L-Shape_3D":
            # Create 3D L-shape (simplified as box for now)
            x, y, z = geometry_params['center']
            lx, ly, lz = geometry_params['dimensions']
        ...
        gmsh.model.mesh.field.setNumbers(field_id, "NodesList", [1])  # Use first node as reference
...
def main():
    ...
    with st.sidebar:
        ...
        if geometry_type == "Box":
            ...
            geometry_params['center'][0] = st.number_input("Center X", value=geometry_params['center'][0])
            geometry_params['center'][1] = st.number_input("Center Y", value=geometry_params['center'][1])
            geometry_params['center'][2] = st.number_input("Center Z", value=geometry_params['center'][2])
            geometry_params['dimensions'][0] = st.number_input("Length X", value=geometry_params['dimensions'][0], min_value=1.0)
            geometry_params['dimensions'][1] = st.number_input("Length Y", value=geometry_params['dimensions'][1], min_value=1.0)
            geometry_params['dimensions'][2] = st.number_input("Length Z", value=geometry_params['dimensions'][2], min_value=1.0)
            ...
            geometry_params['center'][1] = st.number_input("Center Y", value=geometry_params['center'][1])
            geometry_params['center'][2] = st.number_input("Center Z", value=geometry_params['center'][2])
            geometry_params['radius'] = st.number_input("Radius", value=geometry_params['radius'], min_value=0.1)
            geometry_params['height'] = st.number_input("Height", value=geometry_params['height'], min_value=0.1)
            ...
            geometry_params['center'][1] = st.number_input("Center Y", value=geometry_params['center'][1])
            geometry_params['center'][2] = st.number_input("Center Z", value=geometry_params['center'][2])
            geometry_params['major_radius'] = st.number_input("Major Radius", value=geometry_params['major_radius'], min_value=0.1)
            geometry_params['minor_radius'] = st.number_input("Minor Radius", value=geometry_params['minor_radius'], min_value=0.1)
            ...
            geometry_params['center'][1] = st.number_input("Center Y", value=geometry_params['center'][1])
            geometry_params['center'][2] = st.number_input("Center Z", value=geometry_params['center'][2])
            geometry_params['bottom_radius'] = st.number_input("Bottom Radius", value=geometry_params['bottom_radius'], min_value=0.1)
            geometry_params['top_radius'] = st.number_input("Top Radius", value=geometry_params['top_radius'], min_value=0.0)
            geometry_params['height'] = st.number_input("Height", value=geometry_params['height'], min_value=0.1)
            
        elif geometry_type == "L-Shape 3D":
            ...
            geometry_params['dimensions'][1] = st.number_input("Length Y", value=geometry_params['dimensions'][1], min_value=1.0)
            geometry_params['dimensions'][2] = st.number_input("Length Z", value=geometry_params['dimensions'][2], min_value=1.0)
            geometry_params['cut_dimensions'][0] = st.number_input("Cut Length X", value=geometry_params['cut_dimensions'][0], min_value=0.1)
            geometry_params['cut_dimensions'][1] = st.number_input("Cut Length Y", value=geometry_params['cut_dimensions'][1], min_value=0.1)
